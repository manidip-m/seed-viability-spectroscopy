...
<img src="results/figures/nir-raw-spectra.png" width="600" alt="Mean NIR spectra by treatment">

*Mean NIR absorbance spectra for control, microwave-aged, and UV-aged seeds (n = 300 seeds).*

<img src="results/figures/nir-raw-pca.png" width="600" alt="PCA of raw NIR data">

*PCA on the raw spectra already shows some grouping by treatment, though with overlap.*

### NIR spectroscopy — after preprocessing
<img src="results/figures/nir-sg1-pca.png" width="600" alt="NIR PCA after SG1 preprocessing">
...
<img src="results/figures/nir-plsda-confusion-sg1.png" width="700" alt="NIR classification results">

*Both PLS-DA and SVM models reached 100% training, test, and cross-validation accuracy on the SG1-preprocessed data.*

### Raman spectroscopy
<img src="results/figures/raman-raw-spectra-pca.png" width="600" alt="Raw Raman spectra and PCA">

*Raman spectra were dominated by background noise, and PCA showed no clear separation between treatment groups.*

<img src="results/figures/raman-svm-confusion-overfit.png" width="600" alt="Raman overfitting">
...
<img src="results/figures/tetrazolium-test.png" width="500" alt="Tetrazolium test results">
